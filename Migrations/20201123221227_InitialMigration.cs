    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctor_Qualification", x => new { x.DoctorId, x.QualificationId });
                    table.ForeignKey(
                        name: "FK_Doctor_Qualification_Doctor_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Doctor_Qualification_Qualification_QualificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctor_Specialization", x => new { x.SpecializationId, x.DoctorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctor_Qualification_QualificationId",
